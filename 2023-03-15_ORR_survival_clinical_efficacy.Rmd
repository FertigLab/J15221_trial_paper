...
#    rst_plot$table <- rst_plot$table
  ...
  geom_vline(xintercept = 6, linetype="dashed", color = 'grey25')+
     ...
     annotate(geom="text", x=x_6m, y=1, label= text_6m[1],color = subtypeCol["HR+"])+
...
pfs <- plot_surv(dta_pts, "PFS", "Progression Free Survival", xlim = 50, xtext = 35)

os <- plot_surv(dta_pts, "OS", "Overall Survival", x_6m = 12, x_12 = 20)
