...
Wilcoxon test for each time point comparing responders vs non-responders. And paired Wilcoxon p-values for baseline vs post run-in and post run-in vs week 8.
